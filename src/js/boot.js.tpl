...
define([], function() {
    ...
    return {
        boot: function(el, context, config, mediator) {
            ...
            require(['<%= assetPath %>/bandwidth.js']).then(function (bandwidth) {
                console.log('Bandwidth has loaded.');

                bandwidth.default().then((value) => {
                    console.log('Bandwidth value: ', value);
            ...
            // Load JS and init
            require(['<%= assetPath %>/main.js']).then(function (main) {
                console.log('Main has loaded.');

                main.init(el, context, config, mediator);
            }, function (err) {
                console.error('Error loading main:', err);
            });
